...
class AdvisoryInfoCommand : public AdvisorySummaryCommand {
public:
    explicit AdvisoryInfoCommand(Command & parent);
    void print(const libdnf::advisory::AdvisoryQuery & advisories, [[maybe_unused]] std::string & mode) override;
