...
AdvisoryListCommand::AdvisoryListCommand(Command & parent, const std::string & name)
    : AdvisorySummaryCommand(parent, name, "List advisories") {}

void AdvisoryListCommand::process_queries(
